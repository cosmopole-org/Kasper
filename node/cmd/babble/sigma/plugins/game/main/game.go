		...
		import (
			...
			plugger_auth "kasper/cmd/babble/sigma/plugins/game/pluggers/auth"
			action_auth "kasper/cmd/babble/sigma/plugins/game/actions/auth"
			
			plugger_board "kasper/cmd/babble/sigma/plugins/game/pluggers/board"
			action_board "kasper/cmd/babble/sigma/plugins/game/actions/board"
			
			plugger_match "kasper/cmd/babble/sigma/plugins/game/pluggers/match"
			action_match "kasper/cmd/babble/sigma/plugins/game/actions/match"
			
			plugger_meta "kasper/cmd/babble/sigma/plugins/game/pluggers/meta"
			action_meta "kasper/cmd/babble/sigma/plugins/game/actions/meta"
			
			plugger_news "kasper/cmd/babble/sigma/plugins/game/pluggers/news"
			action_news "kasper/cmd/babble/sigma/plugins/game/actions/news"
			
			plugger_player "kasper/cmd/babble/sigma/plugins/game/pluggers/player"
			action_player "kasper/cmd/babble/sigma/plugins/game/actions/player"
			
			plugger_random "kasper/cmd/babble/sigma/plugins/game/pluggers/random"
			action_random "kasper/cmd/babble/sigma/plugins/game/actions/random"
			
			plugger_store "kasper/cmd/babble/sigma/plugins/game/pluggers/store"
			action_store "kasper/cmd/babble/sigma/plugins/game/actions/store"
