		...
		import (
			...
			plugger_auth "kasper/cmd/babble/sigma/plugins/admin/pluggers/auth"
			action_auth "kasper/cmd/babble/sigma/plugins/admin/actions/auth"
			
			plugger_board "kasper/cmd/babble/sigma/plugins/admin/pluggers/board"
			action_board "kasper/cmd/babble/sigma/plugins/admin/actions/board"
			
			plugger_message "kasper/cmd/babble/sigma/plugins/admin/pluggers/message"
			action_message "kasper/cmd/babble/sigma/plugins/admin/actions/message"
			
			plugger_meta "kasper/cmd/babble/sigma/plugins/admin/pluggers/meta"
			action_meta "kasper/cmd/babble/sigma/plugins/admin/actions/meta"
			
			plugger_player "kasper/cmd/babble/sigma/plugins/admin/pluggers/player"
			action_player "kasper/cmd/babble/sigma/plugins/admin/actions/player"
			
			plugger_report "kasper/cmd/babble/sigma/plugins/admin/pluggers/report"
			action_report "kasper/cmd/babble/sigma/plugins/admin/actions/report"
