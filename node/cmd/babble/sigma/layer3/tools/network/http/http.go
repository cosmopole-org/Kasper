...
import (
	...
	modulemodel "kasper/cmd/babble/sigma/layer1/model"
	moduleactormodel "kasper/cmd/babble/sigma/layer1/module/actor"
	"kasper/cmd/babble/sigma/layer2/tools/wasm/model"
...
func New(core abstract.ICore, logger *modulelogger.Logger, maxReqSize int) *HttpServer {
	if maxReqSize > 0 {
		return &HttpServer{sigmaCore: core, logger: logger, shadows: map[string]bool{}, Server: fiber.New(fiber.Config{
