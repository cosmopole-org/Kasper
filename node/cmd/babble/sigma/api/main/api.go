		...
		import (
			...
			plugger_auth "kasper/cmd/babble/sigma/api/pluggers/auth"
			action_auth "kasper/cmd/babble/sigma/api/actions/auth"
			
			plugger_dummy "kasper/cmd/babble/sigma/api/pluggers/dummy"
			action_dummy "kasper/cmd/babble/sigma/api/actions/dummy"
			
			plugger_interact "kasper/cmd/babble/sigma/api/pluggers/interact"
			action_interact "kasper/cmd/babble/sigma/api/actions/interact"
			
			plugger_invite "kasper/cmd/babble/sigma/api/pluggers/invite"
			action_invite "kasper/cmd/babble/sigma/api/actions/invite"
			
			plugger_space "kasper/cmd/babble/sigma/api/pluggers/space"
			action_space "kasper/cmd/babble/sigma/api/actions/space"
			
			plugger_storage "kasper/cmd/babble/sigma/api/pluggers/storage"
			action_storage "kasper/cmd/babble/sigma/api/actions/storage"
			
			plugger_topic "kasper/cmd/babble/sigma/api/pluggers/topic"
			action_topic "kasper/cmd/babble/sigma/api/actions/topic"
			
			plugger_user "kasper/cmd/babble/sigma/api/pluggers/user"
			action_user "kasper/cmd/babble/sigma/api/actions/user"
