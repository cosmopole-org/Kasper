...
import (
	...
	inputstopics "kasper/cmd/babble/sigma/api/inputs/topics"
	"kasper/cmd/babble/sigma/api/model"
	outputstopics "kasper/cmd/babble/sigma/api/outputs/topics"
	updatestopics "kasper/cmd/babble/sigma/api/updates/topics"
...
func (a *Actions) Create(s abstract.IState, input inputstopics.CreateInput) (any, error) {
	...
	future.Async(func(){toolbox.Signaler().SignalGroup("topics/create", topic.SpaceId, updatestopics.Create{Topic: topic}, true, []string{state.Info().UserId()})}, false)
...
func (a *Actions) Update(s abstract.IState, input inputstopics.UpdateInput) (any, error) {
	...
	future.Async(func(){toolbox.Signaler().SignalGroup("topics/update", topic.SpaceId, updatestopics.Update{Topic: topic}, true, []string{state.Info().UserId()})}, false)
...
func (a *Actions) Delete(s abstract.IState, input inputstopics.DeleteInput) (any, error) {
	...
	future.Async(func(){toolbox.Signaler().SignalGroup("topics/delete", topic.SpaceId, updatestopics.Delete{Topic: topic}, true, []string{state.Info().UserId()})}, false)
