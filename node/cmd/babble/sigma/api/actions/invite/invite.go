...
import (
	...
	inputsinvites "kasper/cmd/babble/sigma/api/inputs/invites"
	"kasper/cmd/babble/sigma/api/model"
	outputsinvites "kasper/cmd/babble/sigma/api/outputs/invites"
	updatesinvites "kasper/cmd/babble/sigma/api/updates/invites"
...
func (a *Actions) Create(s abstract.IState, input inputsinvites.CreateInput) (any, error) {
	...
	future.Async(func(){toolbox.Signaler().SignalUser("invites/create", "", input.UserId, updatesinvites.Create{Invite: invite}, true)}, false)
...
func (a *Actions) Cancel(s abstract.IState, input inputsinvites.CancelInput) (any, error) {
	...
	future.Async(func(){toolbox.Signaler().SignalUser("invites/cancel", "", invite.UserId, updatesinvites.Cancel{Invite: invite}, true)}, false)
...
func (a *Actions) Accept(s abstract.IState, input inputsinvites.AcceptInput) (any, error) {
	...
	for _, admin := range admins {
		future.Async(func(){toolbox.Signaler().SignalUser("invites/accept", "", admin.UserId, updatesinvites.Accept{Invite: invite}, true)}, false)
	}
	future.Async(func(){toolbox.Signaler().SignalGroup("spaces/userJoined", invite.SpaceId, updatesinvites.Accept{Invite: invite}, true, []string{})}, false)
...
func (a *Actions) Decline(s abstract.IState, input inputsinvites.DeclineInput) (any, error) {
	...
	for _, admin := range admins {
		future.Async(func(){toolbox.Signaler().SignalUser("invites/decline", "", admin.UserId, updatesinvites.Accept{Invite: invite}, true)}, false)
	}
