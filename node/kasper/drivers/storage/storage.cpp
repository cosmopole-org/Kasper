...
Storage::Storage(std::string basedbPath)
{
    this->basedb = nullptr;
    Options options;
...
void Storage::logPacket(std::string pointId, std::string userId, std::string data)
{
}

std::vector<Packet> Storage::getPacketLogs(std::string pointId, std::string userId)
{
    return {};
}

std::string Storage::generateId(StateTrx *trx, std::string origin)
{
...
TransactionDB *Storage::getBasedb()
{
    return this->basedb;
}
