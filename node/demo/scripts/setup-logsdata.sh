...
docker exec -it logsdb cqlsh 127.0.0.1 9042 -e "create table kasper.storage(id UUID, point_id text, user_id text, data text, time bigint, edited boolean, PRIMARY KEY(id));"
